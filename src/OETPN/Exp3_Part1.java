...
public class Exp3_Part1 {
	...
	public static void main(String[] args) {
		...
		grdT11.Activations.add(new Activation(t1, "PN3", TransitionOperation.Copy, "p3")); /// ??? these lines
		...
		grdT12.Activations.add(new Activation(t1, "PN4", TransitionOperation.Copy, "p3")); /// ??? these lines
