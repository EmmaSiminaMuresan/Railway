...
public class Controller_L11_L12 {
    public static void main(String[] args) {
        ...
        Condition t1Ct2 = new Condition(t1, "Control", TransitionCondition.NotContains,"L11");
        ...
        Condition t1Ct2a = new Condition(t1, "Control", TransitionCondition.Contains,"L11");
        ...
        Condition t2Ct2 = new Condition(t2, "Control", TransitionCondition.NotContains,"L12");
        ...
        Condition t2Ct2a = new Condition(t2, "Control", TransitionCondition.Contains,"L12");
        ...
        Condition t0Ct2a2 = new Condition(t0, "in11_1", TransitionCondition.IsNull);
        Condition t0Ct3a2 = new Condition(t0, "in12_1", TransitionCondition.IsNull);
        Condition t0Ct4a2 = new Condition(t0, "in11_2", TransitionCondition.NotNull);
        Condition t0Ct5a2 = new Condition(t0, "in12_2", TransitionCondition.NotNull);
        ...
        grdt0b.Activations.add(new Activation(t0, "L12", TransitionOperation.Copy, "Control"));
        ...
        grdt0c.Activations.add(new Activation(t0, "Delay", "L11", TransitionOperation.MessageBox_Controllers_TwoLights));
        ...
        grdt0d.Activations.add(new Activation(t0, "Delay", "L12", TransitionOperation.MessageBox_Controllers_TwoLights));
        ...
        grdt0e.Activations.add(new Activation(t0, "Delay", "L11", TransitionOperation.MessageBox_Controllers_TwoLights));
        ...
        Condition t0Ct7f = new Condition(t0, "in11_1", TransitionCondition.MoreThan_Length, "in12_1");
        ...
        grdt0f.Activations.add(new Activation(t0, "Delay", "L11", TransitionOperation.MessageBox_Controllers_TwoLights));
        ...
        Condition t0Ct7g = new Condition(t0, "in12_1", TransitionCondition.MoreThan_Length, "in11_1");
        ...
        grdt0g.Activations.add(new Activation(t0, "Delay", "L12", TransitionOperation.MessageBox_Controllers_TwoLights));
        ...
        Condition t0Ct2i = new Condition(t0, "in11_1", TransitionCondition.NotNull);
        Condition t0Ct3i = new Condition(t0, "in12_1", TransitionCondition.NotNull);
        Condition t0Ct4i = new Condition(t0, "in11_2", TransitionCondition.NotNull);
        Condition t0Ct5i = new Condition(t0, "in12_2", TransitionCondition.NotNull);
        Condition t0Ct6i = new Condition(t0, "in12_2", TransitionCondition.Equal, "in11_2");
        Condition t0Ct7i = new Condition(t0, "in12_1", TransitionCondition.Equal_Length, "in11_1");
        ...
        grdt0i.Activations.add(new Activation(t0, "in12_1", "in12_2", TransitionOperation.CalculateLightTimeRailway, "Delay"));
        grdt0i.Activations.add(new Activation(t0, "Delay", "L11", TransitionOperation.MessageBox_Controllers_TwoLights));
        ...
        grdt0i.Activations.add(new Activation(t0, "red", TransitionOperation.SendOverNetwork, "OP_L11"));
...
//tSetDelay--------------------------------------------------------
        ...
        grdt3.Activations.add(new Activation(t3, "green", TransitionOperation.SendOverNetwork, "OP_L11"));
