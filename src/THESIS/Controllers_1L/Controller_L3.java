...
public class Controller_L3 {
    public static void main(String[] args) {
        ...
        grdt1e3.Activations.add(new Activation(t1, "in_c2", TransitionOperation.CalculateLightTimeStation, "Delay"));
        ...
        // 3 coming trains, dep time C2 > C3, C3 > C2
        ...
        Condition t1Ct6k = new Condition(t1, "in_c3", TransitionCondition.CheckDepartureTime, "in_c2");
