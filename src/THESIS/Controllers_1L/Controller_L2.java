...
public class Controller_L2 {
    public static void main(String[] args) {
        ...
        DataListTrainsQueue in_b1 = new DataListTrainsQueue();
        in_b1.SetName("in_b1");
        ...
        // 3 coming trains, dep time B2 > B3, B3 > B2
        ...
        Condition t1Ct6k = new Condition(t1, "in_b3", TransitionCondition.CheckDepartureTime, "in_b2");
