...
public class Controller_L2 {
    public static void main(String[] args) {
        ...
        DataString temp = new DataString(); //to make sure tSetDelay works before t2
        temp.SetName("temp");
        ...
        pn.PlaceList.add(Delay_Simulation);

        DataListTrains in_b1 = new DataListTrains();
        in_b1.SetName("in_b1");
        //in_b1.SetValue(null); // Explicitly set to null
        pn.PlaceList.add(in_b1);

        DataListTrains in_b2 = new DataListTrains();
        in_b2.SetName("in_b2");
        //in_b2.SetValue(null); // Explicitly set to null
        pn.PlaceList.add(in_b2);

        DataListTrains in_b3 = new DataListTrains();
        in_b3.SetName("in_b3");
        //in_b3.SetValue(null); // Explicitly set to null
...
// t2----------------------------------------------------------------
        ...
        Condition t2Ct2 = new Condition(t2, "temp", TransitionCondition.NotNull);
        ...
        grdt1b.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1b.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1b.Activations.add(new Activation(t1, "g", TransitionOperation.Move, "r"));
        t1.GuardMappingList.add(grdt1b);


        // 1 comming train on B2
        ...
        grdt1c.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1c.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        grdt1d.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1d.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 2 coming trains on B1 B2
        // dep time B1 > dep time B2
        Condition t1Ct1e = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2e = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3e = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4e = new Condition(t1, "in_b3", TransitionCondition.IsNull);
        Condition t1Ct5e = new Condition(t1, "in_b1", TransitionCondition.CheckDepartureTime,"in_b2");
        ...
        grdt1e.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1e.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 2 coming trains on B1 B2
        // dep time B2 > dep time B1
        Condition t1Ct1e1 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2e1 = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3e1 = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4e1 = new Condition(t1, "in_b3", TransitionCondition.IsNull);
        Condition t1Ct5e1 = new Condition(t1, "in_b2", TransitionCondition.CheckDepartureTime,"in_b1");
        ...
        grdt1e1.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1e1.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 2 coming trains on B1 B2
        // dep time B2 = dep time B1 , leaving time B1 > B2
        Condition t1Ct1e2 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2e2 = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3e2 = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4e2 = new Condition(t1, "in_b3", TransitionCondition.IsNull);
        Condition t1Ct5e2 = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime,"in_b2");
        Condition t1Ct6e2 = new Condition(t1, "in_b1", TransitionCondition.CheckLeavingTime,"in_b2");
        ...
        grdt1e2.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1e2.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 2 coming trains on B1 B2
        // dep time B2 = dep time B1 , leaving time B2 > B1
        Condition t1Ct1e3 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2e3 = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3e3 = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4e3 = new Condition(t1, "in_b3", TransitionCondition.IsNull);
        Condition t1Ct5e3 = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime,"in_b2");
        Condition t1Ct6e3 = new Condition(t1, "in_b2", TransitionCondition.CheckLeavingTime,"in_b1");
        ...
        grdt1e3.Activations.add(new Activation(t1, "in_b3", TransitionOperation.CalculateLightTimeStation, "Delay"));
        grdt1e3.Activations.add(new Activation(t1, "Delay", TransitionOperation.CalculateDelay, "Delay_Simulation"));  // Added CalculateDelay
        grdt1e3.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1e3.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 2 coming trains on B1 B3
        // dep time B1 > dep time B3
        Condition t1Ct1f = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2f = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3f = new Condition(t1, "in_b2", TransitionCondition.IsNull);
        Condition t1Ct4f = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5f = new Condition(t1, "in_b1", TransitionCondition.CheckDepartureTime,"in_b3");
        ...
        grdt1f.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1f.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // dep time B3 > dep time B1
        Condition t1Ct1f1 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2f1 = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3f1 = new Condition(t1, "in_b2", TransitionCondition.IsNull);
        Condition t1Ct4f1 = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5f1 = new Condition(t1, "in_b3", TransitionCondition.CheckDepartureTime,"in_b1");
        ...
        grdt1f1.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1f1.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // dep time B3 = dep time B1, leaving time B1 > B3
        Condition t1Ct1f2 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2f2 = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3f2 = new Condition(t1, "in_b2", TransitionCondition.IsNull);
        Condition t1Ct4f2 = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5f2 = new Condition(t1, "in_b3", TransitionCondition.EqualDepartureTime,"in_b1");
        Condition t1Ct6f2 = new Condition(t1, "in_b1", TransitionCondition.CheckLeavingTime,"in_b3");
        ...
        grdt1f2.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1f2.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // dep time B3 = dep time B1, leaving time B3 > B1
        Condition t1Ct1f3 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2f3 = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3f3 = new Condition(t1, "in_b2", TransitionCondition.IsNull);
        Condition t1Ct4f3 = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5f3 = new Condition(t1, "in_b3", TransitionCondition.EqualDepartureTime,"in_b1");
        Condition t1Ct6f3 = new Condition(t1, "in_b3", TransitionCondition.CheckLeavingTime,"in_b1");
        ...
        grdt1f3.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1f3.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 2 coming trains on B2 B3
        // dep time B2 > dep time B3
        Condition t1Ct1g = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2g = new Condition(t1, "in_b1", TransitionCondition.IsNull);
        Condition t1Ct3g = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4g = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5g = new Condition(t1, "in_b2", TransitionCondition.CheckDepartureTime,"in_b3");
        ...
        grdt1g.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1g.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // dep time B3 > dep time B2
        Condition t1Ct1g1 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2g1 = new Condition(t1, "in_b1", TransitionCondition.IsNull);
        Condition t1Ct3g1 = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4g1 = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5g1 = new Condition(t1, "in_b3", TransitionCondition.CheckDepartureTime,"in_b2");
        ...
        grdt1g1.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1g1.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // dep time B3 = dep time B2, leaving time B2 > B3
        Condition t1Ct1g2 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2g2 = new Condition(t1, "in_b1", TransitionCondition.IsNull);
        Condition t1Ct3g2 = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4g2 = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5g2 = new Condition(t1, "in_b3", TransitionCondition.EqualDepartureTime,"in_b2");
        Condition t1Ct6g2 = new Condition(t1, "in_b2", TransitionCondition.CheckLeavingTime,"in_b3");
        ...
        grdt1g2.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1g2.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // dep time B3 = dep time B2, leaving time B3 > B2
        Condition t1Ct1g3 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2g3 = new Condition(t1, "in_b1", TransitionCondition.IsNull);
        Condition t1Ct3g3 = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4g3 = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5g3 = new Condition(t1, "in_b3", TransitionCondition.EqualDepartureTime,"in_b2");
        Condition t1Ct6g3 = new Condition(t1, "in_b3", TransitionCondition.CheckLeavingTime,"in_b2");
        ...
        grdt1g3.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1g3.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 > B2, B2 > B3
        Condition t1Ct1h = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2h = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3h = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4h = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5h = new Condition(t1, "in_b1", TransitionCondition.CheckDepartureTime, "in_b2");
        Condition t1Ct6h = new Condition(t1, "in_b2", TransitionCondition.CheckDepartureTime, "in_b3");
        ...
        grdt1h.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1h.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 > B3, B3 > B2
        Condition t1Ct1i = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2i = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3i = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4i = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5i = new Condition(t1, "in_b1", TransitionCondition.CheckDepartureTime, "in_b3");
        Condition t1Ct6i = new Condition(t1, "in_b3", TransitionCondition.CheckDepartureTime, "in_b2");
        ...
        grdt1i.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1i.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B2 > B1, B1 > B3
        Condition t1Ct1j = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2j = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3j = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4j = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5j = new Condition(t1, "in_b2", TransitionCondition.CheckDepartureTime, "in_b1");
        Condition t1Ct6j = new Condition(t1, "in_b1", TransitionCondition.CheckDepartureTime, "in_b3");
        ...
        grdt1j.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1j.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B2 > B3, B3 > B1
        Condition t1Ct1k = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2k = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3k = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4k = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5k = new Condition(t1, "in_b2", TransitionCondition.CheckDepartureTime, "in_b3");
        Condition t1Ct6k = new Condition(t1, "in_b3", TransitionCondition.CheckDepartureTime, "in_b1");
        ...
        grdt1k.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1k.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B3 > B1, B1 > B2
        Condition t1Ct1l = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2l = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3l = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4l = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5l = new Condition(t1, "in_b3", TransitionCondition.CheckDepartureTime, "in_b1");
        Condition t1Ct6l = new Condition(t1, "in_b1", TransitionCondition.CheckDepartureTime, "in_b2");
        ...
        grdt1l.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1l.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B3 > B2, B2 > B1
        Condition t1Ct1m = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2m = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3m = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4m = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5m = new Condition(t1, "in_b3", TransitionCondition.CheckDepartureTime, "in_b2");
        Condition t1Ct6m = new Condition(t1, "in_b2", TransitionCondition.CheckDepartureTime, "in_b1");
        ...
        grdt1m.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1m.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B2, B3 > B1
        Condition t1Ct1o = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2o = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3o = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4o = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5o = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b2");
        Condition t1Ct6o = new Condition(t1, "in_b3", TransitionCondition.CheckDepartureTime, "in_b1");
        ...
        grdt1o.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1o.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B2, B1 > B3
        Condition t1Ct1o1 = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2o1 = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3o1 = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4o1 = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5o1 = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b2");
        Condition t1Ct6o1 = new Condition(t1, "in_b1", TransitionCondition.CheckDepartureTime, "in_b3");
        ...
        grdt1o1.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1o1.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B3, B2 > B1
        Condition t1Ct1p = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2p = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3p = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4p = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5p = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct6p = new Condition(t1, "in_b2", TransitionCondition.CheckDepartureTime, "in_b1");
        ...
        grdt1p.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1p.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B3, B1 > B2
        Condition t1Ct1q = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2q = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3q = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4q = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5q = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct6q = new Condition(t1, "in_b1", TransitionCondition.CheckDepartureTime, "in_b2");
        ...
        grdt1q.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1q.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B2 = B3, B2 > B1
        Condition t1Ct1r = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2r = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3r = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4r = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5r = new Condition(t1, "in_b2", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct6r = new Condition(t1, "in_b2", TransitionCondition.CheckDepartureTime, "in_b1");
        ...
        grdt1r.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1r.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B2 = B3, B1 > B2
        Condition t1Ct1s = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2s = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3s = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4s = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5s = new Condition(t1, "in_b2", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct6s = new Condition(t1, "in_b1", TransitionCondition.CheckDepartureTime, "in_b2");
        ...
        grdt1s.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1s.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B2 = B3, leaving time B1 > B2, B2 > B3
        Condition t1Ct1t = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2t = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3t = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4t = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5t = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b2");
        Condition t1Ct6t = new Condition(t1, "in_b2", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct7t = new Condition(t1, "in_b1", TransitionCondition.CheckLeavingTime, "in_b2");
        Condition t1Ct8t = new Condition(t1, "in_b2", TransitionCondition.CheckLeavingTime, "in_b3");
        ...
        grdt1t.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1t.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B2 = B3, leaving time B1 > B3, B3 > B2
        Condition t1Ct1u = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2u = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3u = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4u = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5u = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b2");
        Condition t1Ct6u = new Condition(t1, "in_b2", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct7u = new Condition(t1, "in_b1", TransitionCondition.CheckLeavingTime, "in_b3");
        Condition t1Ct8u = new Condition(t1, "in_b3", TransitionCondition.CheckLeavingTime, "in_b2");
        ...
        grdt1u.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1u.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B2 = B3, leaving time B2 > B1, B1 > B3
        Condition t1Ct1v = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2v = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3v = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4v = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5v = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b2");
        Condition t1Ct6v = new Condition(t1, "in_b2", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct7v = new Condition(t1, "in_b2", TransitionCondition.CheckLeavingTime, "in_b1");
        Condition t1Ct8v = new Condition(t1, "in_b1", TransitionCondition.CheckLeavingTime, "in_b3");
        ...
        grdt1v.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1v.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B2 = B3, leaving time B2 > B3, B3 > B1
        Condition t1Ct1w = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2w = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3w = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4w = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5w = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b2");
        Condition t1Ct6w = new Condition(t1, "in_b2", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct7w = new Condition(t1, "in_b2", TransitionCondition.CheckLeavingTime, "in_b3");
        Condition t1Ct8w = new Condition(t1, "in_b3", TransitionCondition.CheckLeavingTime, "in_b1");
        ...
        grdt1w.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1w.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B2 = B3, leaving time B3 > B1, B1 > B2
        Condition t1Ct1x = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2x = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3x = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4x = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5x = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b2");
        Condition t1Ct6x = new Condition(t1, "in_b2", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct7x = new Condition(t1, "in_b3", TransitionCondition.CheckLeavingTime, "in_b1");
        Condition t1Ct8x = new Condition(t1, "in_b1", TransitionCondition.CheckLeavingTime, "in_b2");
        ...
        grdt1x.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1x.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        // 3 coming trains, dep time B1 = B2 = B3, leaving time B3 > B2, B2 > B1
        Condition t1Ct1y = new Condition(t1, "g", TransitionCondition.NotNull);
        Condition t1Ct2y = new Condition(t1, "in_b1", TransitionCondition.NotNull);
        Condition t1Ct3y = new Condition(t1, "in_b2", TransitionCondition.NotNull);
        Condition t1Ct4y = new Condition(t1, "in_b3", TransitionCondition.NotNull);
        Condition t1Ct5y = new Condition(t1, "in_b1", TransitionCondition.EqualDepartureTime, "in_b2");
        Condition t1Ct6y = new Condition(t1, "in_b2", TransitionCondition.EqualDepartureTime, "in_b3");
        Condition t1Ct7y = new Condition(t1, "in_b3", TransitionCondition.CheckLeavingTime, "in_b2");
        Condition t1Ct8y = new Condition(t1, "in_b2", TransitionCondition.CheckLeavingTime, "in_b1");
        ...
        grdt1y.Activations.add(new Activation(t1, "Delay", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        grdt1y.Activations.add(new Activation(t1, "Delay_Simulation", "L2", TransitionOperation.MessageBox_Controllers_OneLight));
        ...
        tSetDelay.InputPlaceName.add("Delay_Simulation");


        Condition tSetCt1 = new Condition(tSetDelay, "r", TransitionCondition.NotNull);
        Condition tSetCt2 = new Condition(tSetDelay, "Delay_Simulation", TransitionCondition.NotNull);


        tSetCt1.SetNextCondition(LogicConnector.AND, tSetCt2);


        GuardMapping grdtSet = new GuardMapping();
        grdtSet.condition= tSetCt1;
        grdtSet.Activations.add(new Activation(tSetDelay, "Delay_Simulation", TransitionOperation.Move,"Delay_Simulation"));
        grdtSet.Activations.add(new Activation(tSetDelay, "red", TransitionOperation.Move, "temp")); //to make sure it executes before  t2
        grdtSet.Activations.add(new Activation(t2, "Delay_Simulation", TransitionOperation.DynamicDelay,""));
        ...
        System.out.println("Controller L2 started \n ------------------------------");
        pn.Delay = 3000;
