...
public class Controller_L2 {
    public static void main(String[] args) {
        ...
        Condition t1CtAllNull = new Condition(t1, "in_b1", TransitionCondition.IsNull);
        t1CtAllNull.SetNextCondition(LogicConnector.AND, new Condition(t1, "in_b2", TransitionCondition.IsNull));
        t1CtAllNull.SetNextCondition(LogicConnector.AND, new Condition(t1, "in_b3", TransitionCondition.IsNull));
...
// t2----------------------------------------------------------------
        ...
        frame.setTitle("Controller L2 - A Station");
        frame.petriNet = pn;
