...
// t4 ------------------------------------------------
        ...
        grdt0a.Activations.add(new Activation(
                ...
                p4.GetName()));
        grdt0a.Activations.add(new Activation(t0,p4.GetName(), TransitionOperation.MessageBox_SupervisorB));
        ...
        grdt0d1.Activations.add(new Activation(t0, "Train_B",
                ...
                TransitionOperation.CreateTrain_Null,
                "D_Train_B"));
        grdt0d1.Activations.add(new Activation(t0, "D_Train_B", TransitionOperation.MessageBox_SupervisorB));
        ...
        grdt0d2.Activations.add(new Activation(t0, "Train_B",
                ...
                TransitionOperation.CreateTrain_Null,
                "D_Train_B"));
        grdt0d2.Activations.add(new Activation(t0, "D_Train_B", TransitionOperation.MessageBox_SupervisorB));
        ...
        grdt0e1.Activations.add(new Activation(t0,"Train_B",
                ...
                TransitionOperation.CreateTrain_Null,
                "D_Train_B"));
        grdt0e1.Activations.add(new Activation(t0, "D_Train_B", TransitionOperation.MessageBox_SupervisorB));
        ...
        grdt0e2.Activations.add(new Activation(t0,"Train_B",
                ...
                TransitionOperation.CreateTrain_Null,
                "D_Train_B"));
        grdt0e2.Activations.add(new Activation(t0, "D_Train_B", TransitionOperation.MessageBox_SupervisorB));
        ...
        grdt0e3.Activations.add(new Activation(t0,"Train_B",
                ...
                TransitionOperation.CreateTrain_Null,
                "D_Train_B"));
        grdt0e3.Activations.add(new Activation(t0, "D_Train_B", TransitionOperation.MessageBox_SupervisorB));
        ...
        grdt0f1.Activations.add(new Activation(t0,"Train_B",
                ...
                TransitionOperation.CreateTrain_Null,
                "D_Train_B"));
        grdt0f1.Activations.add(new Activation(t0, "D_Train_B", TransitionOperation.MessageBox_SupervisorB));
