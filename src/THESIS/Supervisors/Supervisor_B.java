...
public class Supervisor_B {
    public static void main(String[] args) {
        ...
        Condition t5Ct1b = new Condition(t5, "C_TimeB2", TransitionCondition.NotNull);
        ...
        Condition t5Ct1c = new Condition(t5, "C_TimeB3", TransitionCondition.NotNull);
        ...
        Condition t5Ct1d = new Condition(t5, "C_TimeB4", TransitionCondition.NotNull);
        ...
        Condition t6Ct1b = new Condition(t6, "C_PB2", TransitionCondition.NotNull);
        ...
        Condition t6Ct1c = new Condition(t6, "C_PB3", TransitionCondition.NotNull);
        ...
        Condition t6Ct1d = new Condition(t6, "C_PB4", TransitionCondition.NotNull);
        ...
        grdt0c.Activations.add(new Activation(t0,"Train_B","Dep_Time_B","Platform_B",null,"B3_Length","Zero","Speed_On_Platform", TransitionOperation.CreateTrain_Null, "D_Train_B"));
        ...
        grdt0f.Activations.add(new Activation(t0,"Train_B","Dep_Time_B","Platform_B","H_List_B","B3_Length","Zero","Speed_On_Platform", TransitionOperation.CreateTrain_Null, "D_Train_B"));
        ...
        grdt0i.Activations.add(new Activation(t0,"Train_B","Dep_Time_B","Platform_B","C_TimeB","C_PB",null,"B3_Length","Zero","Speed_On_Platform", TransitionOperation.CreateTrain_NotNull, "D_Train_B"));
        ...
        grdt4a.Activations.add(new Activation(t4, "List_B", TransitionOperation.SendTrainOverNetwork, "T1_B"));
        grdt4a.Activations.add(new Activation(t4, "List_B", TransitionOperation.SendOverNetwork, "Time1_B"));
        ...
        grdt4b.Activations.add(new Activation(t4, "List_B", TransitionOperation.SendTrainOverNetwork, "T2_B"));
        grdt4b.Activations.add(new Activation(t4, "List_B", TransitionOperation.SendOverNetwork, "Time2_B"));
        ...
        grdt4c.Activations.add(new Activation(t4, "List_B", TransitionOperation.SendTrainOverNetwork, "T3_B"));
        grdt4c.Activations.add(new Activation(t4, "List_B", TransitionOperation.SendOverNetwork, "Time3_B"));
